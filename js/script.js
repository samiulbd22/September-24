...
const members = {
    ...
    "01814843266":{
        ...
        payment             :{"01/09/24-Cash":4500},
        // running month {"01/07/24-Cash":500}
        stay_cost       :2200,
        garage_cost     :0,
        running_payable :2700,
        running_paid    :4500,
        running_meal    :30,
        // method calling
        preMonth,
    ...
    "01922362569":{
        ...
        payment             :{"01/09/24-DBBL":500,"10/09/24-Cash":2000,"16/09/24-Cash":500,"23/09/24-Cash":500,"26/09/24-DBBL":500,"30/09/24-DBBL":500},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :3021,
        running_paid    :4500,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01744459622":{
        ...
        payment             :{"09/09/24-Cash":5000,"23/09/24-Cash":1000},
        // running month
        stay_cost       :2700,
        garage_cost     :200,
        running_payable :3994,
        running_paid    :6000,
        running_meal    :28,
        // method calling
        preMonth,
    ...
    "01780608997":{
        ...
        previous_paid       :4500,
        previous_dining_cost:1425,
        payment             :{"12/09/24-Cash":6500,"27/09/24-Cash":500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
    ...
    "01645122114":{
        ...
        previous_paid       :6000,
        previous_dining_cost:1425,
        payment             :{"13/09/24-Bkash":4000,"27/09/24-Cash":500,"30/09/24-Dismiss":500},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :4350,
        running_paid    :5000,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01714443406":{
        ...
        previous_paid       :3500,
        previous_dining_cost:1425,
        payment             :{"05/09/24-Cash":5000,"22/09/24-Cash":1000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :4337,
        running_paid    :6000,
        running_meal    :62,
        // method calling
        preMonth,
    ...
    "01834648400":{
        ...
        payment             :{"18/08/24-Cash":5100,"04/09/24-Cash":1000,"27/09/24-Bkash":1000},
        // running month
        stay_cost       :2500,
        garage_cost     :0,
        running_payable :4453,
        running_paid    :7100,
        running_meal    :29,
        // method calling
        preMonth,
    ...
    "01749244430":{
        ...
        payment             :{"01/09/24-Cash":3500,"08/09/24-Cash":2000,"16/09/24-Cash":1500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
